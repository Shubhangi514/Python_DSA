...
# C. 4 7 11 15 
# D. 12,13,14,15
# Note that the pop() method modifies the original list, so the inner lists in arr have been shortened as elements are removed from their ends.
