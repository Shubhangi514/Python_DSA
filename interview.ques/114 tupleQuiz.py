...
# The expression (_, n) in the generator unpacks each tuple into two variables, but discards the first variable using the underscore _. This is because we are only interested in the second element of each tuple.
